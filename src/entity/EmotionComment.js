...
exports.EmotionComment = exports.EmotionType = void 0;
...
__decorate([
    ...
    __metadata("design:type", String)
], EmotionComment.prototype, "emotionType", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_1.User, (user) => user.emotionComments),
    (0, typeorm_1.JoinColumn)({ name: 'userId', referencedColumnName: 'id' }),
    __metadata("design:type", User_1.User)
], EmotionComment.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Comment_1.Comment, (comment) => comment.emotions),
    (0, typeorm_1.JoinColumn)({ name: 'commentId', referencedColumnName: 'id' }),
    __metadata("design:type", Comment_1.Comment)
], EmotionComment.prototype, "comment", void 0);
exports.EmotionComment = EmotionComment = __decorate([
    (0, typeorm_1.Entity)('emotion_comments'),
